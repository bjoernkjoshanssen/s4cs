...
\begin{parts}
	\item 
		What is the probability that you will see the first head on the third flip? The tenth flip? The hundredth flip?
	\item
		What is the least $n$ such that seeing the first head after $n$ flips results in a Z-score greater than 3?
