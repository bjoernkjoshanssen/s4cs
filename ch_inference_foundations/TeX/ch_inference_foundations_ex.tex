...
\eoce{\qt{Geometric mean of lognormal}
	...
	Hint: at some point, use $u$-substitution.
}{}
...
\eoce{\qt{More votes for Alice}
	In Section \ref{oct-24-2025}, if instead Alice has 540 voters' support then can we say with 95\% confidence that she will win?
}{}
