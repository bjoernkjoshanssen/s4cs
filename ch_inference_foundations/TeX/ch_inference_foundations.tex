...
%   \caption{The 95\% confidence interval is a random variable which usually, but not always, contains the mean $\mu$, which is itself not random.}
...
%\begin{example}{Other continuous distribuions.}\label{lognormal}
