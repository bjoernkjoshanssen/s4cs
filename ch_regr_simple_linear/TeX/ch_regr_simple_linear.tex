...
The definition of $P$ and $Q$ having no \term{interaction} on $X$ is $E(X\mid P,Q)+E(X)= E(X\mid P)+E(X\mid Q)$. In other words, the effect of $P$ on $X$ is independent of $Q$: $E(X\mid P)-E(X) = E(X\mid P,Q)-E(X\mid Q)$. %The left-hand side is $\frac{E(X 1_P)-E(X)E(1_P)}{E(1_P)}$.
