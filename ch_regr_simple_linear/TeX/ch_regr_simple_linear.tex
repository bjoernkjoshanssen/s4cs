...
%To derive the formulas for linear regression we proceed as follows.
...
%The varying fit of the three graphs in Figure~\ref{imperfLinearModel} correspond to varying variances for the random variables at a given $x$-value. Or, if we do not assume that any linear model is appropriate at all, they just correspond to varying correlations between $x$ and $y$.
