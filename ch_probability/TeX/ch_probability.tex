...
\]
However, if we consider $p$ to be a random variable, then any particular value will have probability 0 and we should be considering the \term{probability density function} (see \Cref{contDist}) instead:
