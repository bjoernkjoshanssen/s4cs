...
\]
This is not possible to solve with an exact formula, but we can use a tool available
at \url{https://stats.blue/Stats_Suite/logistic_regression_calculator.html}.
Entering the scores 1,0,0 in the ``Success/Failure'' column and 60,30,20 in the ``Explanatory variable $x_1$'' column,
we obtain $\beta_0=-59.3709$ and $\beta_1=1.3214$.
