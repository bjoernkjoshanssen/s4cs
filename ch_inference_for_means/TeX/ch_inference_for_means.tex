...
%The (+) is clearly
%\[
%	s^2_{\text{pooled}}=\frac{\sum(x_{1,i}-\overline x_1)^2 + \sum(x_{0,j}-\overline x_0)^2}{n_1+n_2-2}
%	= \frac{\sum_i x_{1,i}^2 + \sum_j x_{0,j}^2 - n_1(\overline x_1)^2 - n_2(\overline x_2)^2}{n_1+n_2-2}
%\]
%so it is giving each squared difference equal weight.
%Note that the overall mean is
%\[
%	\overline x = \frac{n_1\overline x_1 + n_2\overline x_2}{n_1+n_2}
%\]
%and
%\[
%	(n_1+n_2)(\overline x)^2 = 
%\]
